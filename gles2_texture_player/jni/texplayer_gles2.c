...
void stream_texture(int dev, void *dev2texturearg)
{
//    const GLubyte *bc_dev_name;
    int no_buffers, width, height, format;
    int idx;
	GLenum *mydev2texture = (GLenum*)dev2texturearg;
    ...
    glActiveTexture(mydev2texture[dev]);
...
void gles2_deinit_glstate(void)
{
