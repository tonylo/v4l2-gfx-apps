...
Modifications :-
$Log: Gles1TexturePlayer.java $
Revision 1.1  2010/10/22 11:04:00  tony.lofthouse
Initial revision
******************************************************************************/

package com.imgtec.powervr.ddk.Gles1TexturePlayer;
...
public class Gles1TexturePlayer extends Activity
			  implements SurfaceHolder.Callback, OnItemSelectedListener
{
	...
	private static final String mJni_library_locn =
		"/lib/libgles1_texture_player.so";
	...
	private class ViewTouchHandler implements OnTouchListener {
		...
		private Gles1TexturePlayer mActivity;
		public ViewTouchHandler(Gles1TexturePlayer mainactivity) {
	...
	private class ButtonClickhandler implements OnClickListener {
		 ...
		 *                      class device.
		 */
		public ButtonClickhandler(Gles1TexturePlayer activity, boolean launchvideo) {
			mActivity = activity;
	...
	public void doLaunchVideo() { mLaunchVideo = true; }
	public void doNotLaunchVideo() { mLaunchVideo = false; }
